/**
 * All site copy lives here so the sections stay purely presentational.
 * Copy is adapted from martaempire.com and restructured for the new build.
 */
...
export const mantras = [
  "Fewer clients. Higher entry. Deeper work.",
  "Structure is the throne. Everything else is decoration.",
  "Your identity is the strategy. Everything else is execution.",
  "You do not lower your throne. You raise the entry.",
  "Depth is the differentiator. Presence is the leverage.",
  "Soul becomes a decision.",
];
...
export const whereYouAre = {
  ...
  quote: "The woman who built this business is not the woman who will carry its legacy.",
  quoteBy: "Marta Szkudlarek · Queen Identity mentor",
};
